...
class Column extends Component{
    ...
    addRow(){
        ...
        let lowerNeighbor = (length == 0 ? null : this.state.rows[length - 1]); // Accounting for the first element in the list
        ...
        const panResponder = PanResponder.create({
            ...
            onPanResponderMove : (e, gestureState) => {
                ...
                Animated.event([null,{
                    // Uncomment the dx property below to be able to drag items across columns
                ...
                /********* The following code is an attempt to be able to move  */
    ...
    /* Create a callback function to allow the child components (Rows) to update width, height, and coords */
